...
pub const CLAUDE_ENDPOINT: &str = "https://jinhan1414-denoproxy-51.deno.dev/https://api.anthropic.com";
pub const CLAUDE_CONSOLE_ENDPOINT: &str = "https://jinhan1414-denoproxy-51.deno.dev/https://console.anthropic.com";
